  ...
  return (
    <>
      ...
      <Spotlight
        ...
        color={'rgb(128, 255, 248)'}
      />
      <div className="relative w-full h-full loginBg">
        {/* Login Form */}
                ...
                <div className="mt-10 text-right">
                  <p className="text-sm text-text-disabled">
                    ...
                    <Button
                      variant={'transparent'}
                      onClick={changeTitle}
                      className="font-medium transition-colors duration-200 border-none text-accent-primary/90 hover:text-accent-primary hover:bg-transparent"
                    >
                      {t('signUp')}
                    </Button>
                  </p>
