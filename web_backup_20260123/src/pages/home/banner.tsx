...
export function Banner() {
  return (
    <section className="bg-gradient-to-r from-red-500 to-red-900 bg-cover h-28 rounded-2xl  my-8 flex gap-8 justify-between">
      <div className="h-full text-3xl font-bold items-center inline-flex ml-6">
        Welcome to 东方国信智能知识中台
      </div>
...
export function NextBanner() {
  ...
  return (
    <section className="text-5xl pt-10 pb-14 font-bold px-10">
      ...
      <span className="pl-3 text-transparent bg-clip-text bg-gradient-to-l from-[#FF4D4D] to-[#A30000]">
        东方国信智能知识中台
      </span>
    </section>
  );
